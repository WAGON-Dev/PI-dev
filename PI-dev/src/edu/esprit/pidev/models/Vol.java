...
public class Vol {
    ...
    public Vol(Date date_depart, Date date_arrivee, Double prix_vol, String nom_Vol, int client_vol_fk, String depart, String arrivee, String nom_Compagnie) {
        this.date_depart = date_depart;
        this.date_arrivee = date_arrivee;
        this.prix_vol = prix_vol;
    ...
    public String toString() {
        return "Vol{" + "numTicket=" + numTicket + ", date_depart=" + date_depart + ", date_arrivee=" + date_arrivee + ", prix_vol=" + prix_vol + ", nom_Vol=" + nom_Vol + ", client_vol_fk=" + client_vol_fk + ", depart=" + depart + ", arrivee=" + arrivee + ", nom_Compagnie=" + nom_Compagnie + '}';
    }
